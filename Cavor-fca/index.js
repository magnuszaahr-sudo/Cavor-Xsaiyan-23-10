/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║       CAVOR-FCA v4.0 — Facebook Client Abstractions               ║
 * ║       Copyright © 2025 CAVOR — Cavor-Xv3-11/x Bot Engine                ║
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Features:
 ...
 *  ✦ [v4.0] api.cavor — Media helpers: sendPhoto, sendVideo, sendAudio,
...
function login(cookieInput, opts, callback) {
  ...
  if (!appState.length)
    return callback(new Error("[Cavor-fca] لا توجد كوكيز صالحة"), null);
  if (!hasMandatory(appState))
    return callback(new Error("[Cavor-fca] الكوكيز ناقصة: c_user أو xs مفقود"), null);
